...
export function HomeFeaturesSection() {
  return (
    <section className="relative border-t border-white/[0.06] px-6 py-24" aria-labelledby="why-heading">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f, i) => (
            <article
              key={f.rule}
              className={`group relative rounded-xl border border-white/[0.08] border-l-2 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/[0.15] hover:bg-white/[0.05] hover:-translate-y-1`}
            >
